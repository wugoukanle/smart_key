...
/*授权*/
#define AUTHOR_ROW    0x180000  //授权用户信息条数,最大25条

#define AUTHOR_POINT  0x180004  //当前授权用户信息的指针

#define AUTHOR_START    0x080000   //授权文件,25*24B=600B
#define AUTHOR_END      0x0BFFFF




/*采码*/
#define CAIMA_ROW			0x180008	//采码的条数最大30条

#define CAIMA_POINT		0x18000C

#define CAIMA_SUO_POINT 0x180010	//采码时锁码的存储指针

#define CAIMA_START			0x0C0000   //采码,30*8B=240B
#define CAIMA_END				0x0FFFFF
...
/*记录*/
#define RECORD_ROW		0x180014  //操作记录最大100条

#define RECORD_POINT  0x180018

#define RECORD_START		0x100000		//操作记录,100*10B=1000B
#define RECORD_END			0x13FFFF
...
/*巡检*/
#define XUNJIAN_ROW		0x18001C  //大巡检任务最大10个
