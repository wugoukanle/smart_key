...
{  
	...
	{  
		...
		OLED_WR_Byte (0x02,OLED_CMD);      //设置显示位置—列低地址，从第2列开始
...
/*
*@功能：显示显示BMP图片128×64起始点坐标(x,y),x的范围0～127，y为页的范围0～7
*/
